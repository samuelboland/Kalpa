...
# =                            Personal Additions                              =
# ==============================================================================
# This is necessary to help with memory isses. Enabling experimental
...
D_B = module.ConvDiscriminator(input_shape=(args.crop_size, args.crop_size, 4))
...
def train_G(A, B):
    with tf.GradientTape() as t:
        ...
        G_loss = (A2B_g_loss + B2A_g_loss) + (A2B2A_cycle_loss + B2A2B_cycle_loss) * cycle_loss_weight + (A2A_id_loss + B2B_id_loss) * args.identity_loss_weight
...
# Personal Code:
# We will lower cycle loss weight over time.
# Finding value that we can lower by without hitting 0 at the end.
amount_to_lower = (cycle_loss_weight / args.epochs)
...
with train_summary_writer.as_default():
    for ep in tqdm.trange(args.epochs, desc='Epoch Loop'):
        ...
        # Personal Code:
        # Lower cycle loss weight slightly
        #cycle_loss_weight = cycle_loss_weight - (amount_to_lower/2)
        #print("Current Cycle Loss Weight is " + str(cycle_loss_weight))
        ...
        for A, B in tqdm.tqdm(A_B_dataset, desc='Inner Epoch Loop', total=len_dataset):
            ...
            if G_optimizer.iterations.numpy() % 50 == 0: # Originally set to 100
                ...
                im.imwrite(img, py.join(sample_dir, 'iter-%09d.png' % G_optimizer.iterations.numpy()))
